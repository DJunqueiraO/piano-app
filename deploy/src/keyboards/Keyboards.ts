...
import { DefaultHorizontalInterval8 } from "./default_horizontal_interval_8/DefaultHorizontalInterval8"
...
export abstract class Keyboards {
  ...
  static default_horizontal_interval_8 = "Keyboard Interval 8"
  ...
  static get(name: string) {
    switch(name) {
      ...
      case Keyboards.default_horizontal_interval_8:
        return DefaultHorizontalInterval8
